function [p,t,h] = quadtree(node,edge,hdata,dhmax,output,fid)
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
if output
  s_msg = 'Estimating local geometry feature size';
  if ( fid>0 )
    fprintf(fid,[s_msg,'\n'])
  else
    gui_Message( s_msg, 2 )
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
if output
  s_msg = 'Forming element size function';
  if ( fid>0 )
    fprintf(fid,[s_msg,'\n'])
  else
    gui_Message( s_msg, 2 )
